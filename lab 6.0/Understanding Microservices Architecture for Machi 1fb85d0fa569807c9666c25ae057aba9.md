...
![monolithic vs microservices architecture.drawio (1).png](images/monolithic_vs_microservices_architecture.drawio_(1).png)
...
![monolithic vs microservices architecture-communication patterns.drawio (1).png](images/monolithic_vs_microservices_architecture-communication_patterns.drawio_(1).png)
...
![images/monolithic vs microservices architecture-stateful vs stateless.drawio.png](images/monolithic_vs_microservices_architecture-stateful_vs_stateless.drawio.png)
